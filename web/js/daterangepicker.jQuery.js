(function ($) {
	...
	$.fn.daterangepicker = function(settings){
		...
		var options = $.extend({
			presetRanges: [
				{text: $.i18n.prop('datapicker_today'), dateStart: 'today', dateEnd: 'today' },
				{text: $.i18n.prop('datepicker_last7day'), dateStart: 'today-7days', dateEnd: 'today' },
				{text: $.i18n.prop('datepicker_month_to_date'), dateStart: function(){ return Date.parse('today').moveToFirstDayOfMonth();  }, dateEnd: 'today' },
				{text: $.i18n.prop('datepicker_year_to_date'), dateStart: function(){ var x= Date.parse('today'); x.setMonth(0); x.setDate(1); return x; }, dateEnd: 'today' },
				//extras:
				{text: $.i18n.prop('datepicker_previous_month'), dateStart: function(){ return Date.parse('1 month ago').moveToFirstDayOfMonth();  }, dateEnd: function(){ return Date.parse('1 month ago').moveToLastDayOfMonth();  } },
				{text:$.i18n.prop('datepicker_tomorrow'), dateStart: 'Tomorrow', dateEnd: 'Tomorrow' },
				{text:$.i18n.prop('datepicker_last30days'), dateStart: 'Today-30', dateEnd: 'Today' },
				{text:$.i18n.prop('datepicker_next30days'), dateStart: 'Today', dateEnd: 'Today+30' },
			...
			presets: {
				specificDate: $.i18n.prop('datepicker_specific_date'),
				allDatesBefore: $.i18n.prop('datepicker_all_dates_before'),
				allDatesAfter: $.i18n.prop('datepicker_all_dates_after'),
				dateRange: $.i18n.prop('datepicker_date_range')
		},
